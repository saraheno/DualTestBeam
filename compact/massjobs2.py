...
nenergy=2
energies=[10,30]
name="condor-executable-fSCEPonly-"
...
while (i<nenergy):
    ...
    shfile.write('ddsim --compactFile=/home/eno/CalVision/dd4hep/DD4hep/examples/DualTestBeam/compact/DRFSCEPonly.xml --runType=batch -G --steeringFile /home/eno/CalVision/dd4hep/DD4hep/examples/DualTestBeam/compact/SCEPCALsteering.py --outputFile=./output/out_fSCEPonly_20GeV_e-_100.root --part.userParticleHandler='' -G --gun.position="0.,0.,-210*cm" --gun.direction "0 0.05 0.99875" --gun.energy "'+str(energies[i])+'*GeV" --gun.particle="e-" -N 100 >& ./output/sce_e_fSCEPonly_'+str(energies[i])+'.log'+'\n')
