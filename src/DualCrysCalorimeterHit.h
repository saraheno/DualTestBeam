...
namespace CalVision {
	...
	class DualCrysCalorimeterHit : public dd4hep::sim::Geant4Calorimeter::Hit {
		...
		public: // Default constructor
			...
			DualCrysCalorimeterHit(const Position& cell_pos):dd4hep::sim::Geant4Calorimeter::Hit(cell_pos),
			ncerenkov(0),nscintillator(0),edeprelativistic(0.),n_inelastic(0),edepepgam(0) { // Initializing constructor
	...
	class Dump   {
		public: // Standalone function to dump data from a root file
