...
//
//==========================================================================
#ifndef DDG4_SCEGEANT4OUTPUT2ROOT_H
#define DDG4_SCEGEANT4OUTPUT2ROOT_H
...
namespace dd4hep {
  ...
  namespace sim {
     ...
     */
    class SCEGeant4Output2ROOT: public Geant4OutputAction {
    protected:
    ...
    public:
      ...
      SCEGeant4Output2ROOT(Geant4Context* context, const std::string& nam);
      /// Default destructor
      virtual ~SCEGeant4Output2ROOT();
